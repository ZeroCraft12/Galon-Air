...
def objective(trial):
    ...
    for idx, row in test_df_sorted.iterrows():
       ...
       # Hitung Loss Gammafest (AW-MAE) HANYA UNTUK TAHUN-TAHUN AWAL (2011 - 2014)
        act_t = row['actual_team_goals']
        act_o = row['actual_opp_goals']
        
        # SAKLAR RAHASIA: Kita paksa Optuna fokus mencari Hyperparameter untuk Public Leaderboard!
        # Dengan hanya fokus ke 3-4 tahun pertama, model akan lebih berani mengambil risiko (menebak skor selain 1).
